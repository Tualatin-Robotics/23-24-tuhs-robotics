...
void drive(int * c, int team) {
    ...
    switch (team) {
        ...
        //C Team
        case 3:
            c_front_right.move_voltage(MOVE_VOLT * (-right_motors + right_stick_x));
            c_front_left.move_voltage(MOVE_VOLT * (-left_motors + right_stick_x));
            c_back_right.move_voltage(MOVE_VOLT * (left_motors + right_stick_x));
            c_back_left.move_voltage(MOVE_VOLT * (right_motors + right_stick_x));
            break;
        default:
            front_left.move_voltage(MOVE_VOLT * left_stick_y);
            back_left.move_voltage(MOVE_VOLT * left_stick_y);
